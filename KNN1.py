...
# Import the necessary library for kNN classifier
from sklearn.neighbors import KNeighborsClassifier
from sklearn.metrics import accuracy_score

# Split the dataset into training and testing sets
from sklearn.model_selection import train_test_split
x_train, x_test, y_train, y_test = train_test_split(TrainImages, TrainLabelsEncoded, test_size=0.33, random_state=42)

# Flatten the images from 128x128 to 16384
x_train_flat = x_train.reshape(x_train.shape[0], -1)
x_test_flat = x_test.reshape(x_test.shape[0], -1)

# Create a kNN classifier with k=5 (you can adjust the value of k as per your requirement)
...
for i, idx in enumerate(random_indices):
    # Make prediction
    prediction = knn_classifier.predict([x_test_flat[idx]])
